...
## URL Map
```
/                                           → public_pages:home (landing page with hero, mobile-only PWA install card under hero, featured articles, live RSS news widget, key rights, resources)
